...
import com.xiaoerzuche.common.core.data.redis.hash.DefaultHashType;
import com.xiaoerzuche.common.core.data.redis.hash.HashType;
import com.xiaoerzuche.common.core.data.redis.hash.LongHashType;
import com.xiaoerzuche.common.core.data.redis.hash.StringHashType;
import com.xiaoerzuche.common.core.data.redis.pool.IJedisPool;
import com.xiaoerzuche.common.util.ClassUtil;
...
public class RedisHashImpl extends AbstractRedis implements Redis {
	...
	protected Redis initRedis(String server) {
		if (log) {
			...
			RedisImpl redis = new RedisImpl(server, maxActive, initialPoolSize, timeout);
			redis.init();
			return redis;
		}
	}
