...
public class NumberUtil {
	...
	public static double substarct(double a, double b){
		BigDecimal DecimalA = new BigDecimal(String.valueOf(b)) ;
  		BigDecimal DecimalResult = new BigDecimal(String.valueOf(a)).subtract(DecimalA);
  		return DecimalResult.doubleValue();
	}
