...
//        DateUtils.parseDate(certNo.substring(6, 12), "yyyyMM");
     ...
     * @return
     */
    public static Integer getGender(String isIDCard){
    	Integer gender = Integer.parseInt(isIDCard.substring(16, 17));
    	gender = gender%2;
    	return gender;
    }
...
//    	420502198004120048
//    	460002198703290513
    	String iDCard = "610126198811093511";
    	System.out.println(IDCardUtil.isIDCard(iDCard));
    }
