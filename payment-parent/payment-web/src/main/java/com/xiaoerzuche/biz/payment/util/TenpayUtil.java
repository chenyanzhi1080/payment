...
public class TenpayUtil {
	 ...
	 * @throws Exception
	 */
	public static String getCodeUrl(String xml) throws Exception {
		if (null == xml) {
			return null;
		}
	 ...
	 * @throws Exception
	 */
	public static String getPayNo(String xml) throws Exception {
		if (null == xml) {
			return null;
		}
		Map map = doXMLParse(xml);
    ...
    public static void main(String[] args){
    	String str = TenpayUtil.getStringRandom(32);
