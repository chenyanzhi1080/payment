 ...
 * 
 */
package com.xiaoerzuche.biz.payment.alipayment.alipay.wappay.security;
...
import com.xiaoerzuche.biz.payment.alipayment.alipay.wappay.util.StringUtil;
...
public static String sign(String content, String key) throws Exception {
	...
	public static boolean verify(String content, String sign, String key)
			throws Exception {
		  String tosign = (content == null ? "" : content) + key;
		  System.out.println("verifydata:"+tosign);
	        try {
