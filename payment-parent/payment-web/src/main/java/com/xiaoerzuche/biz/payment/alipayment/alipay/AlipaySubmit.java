...
import com.xiaoerzuche.biz.payment.alipayment.alipay.httpClient.HttpProtocolHandler;
import com.xiaoerzuche.biz.payment.alipayment.alipay.httpClient.HttpRequest;
import com.xiaoerzuche.biz.payment.alipayment.alipay.httpClient.HttpResponse;
import com.xiaoerzuche.biz.payment.alipayment.alipay.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
		...
		if (AliPayConfig.sign_type.equals("MD5")) {
			...
			System.out.println("passPartner:" + (AliPayConfig.partner.equals(sPara.get("partner"))));
			System.out.println("beforeKey:" + key);
			if (AliPayConfig.partner.equals(sPara.get("partner"))) {
				key = AliPayConfig.partner;
			} else {
	...
	public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
		...
		sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\""
						+ "https://mapi.alipay.com/gateway.do?" + "_input_charset=" + AliPayConfig.input_charset
						+ "\" method=\"" + strMethod + "\">");
