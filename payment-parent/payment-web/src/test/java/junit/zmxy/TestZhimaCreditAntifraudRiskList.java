...
public class TestZhimaCreditAntifraudRiskList {
	//芝麻开放平台地址
    ...
    public void  testZhimaCreditAntifraudRiskList() {
        ...
        req.setCertNo("161010219871208001x");// 必要参数 
        req.setName("田嘉伟");// 必要参数 
        req.setMobile("18691954192");// 
    ...
    public static void main(String[] args) {
        TestZhimaCreditAntifraudRiskList result = new  TestZhimaCreditAntifraudRiskList();
